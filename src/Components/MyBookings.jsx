  ...
  if (bookings.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center ">
        ...
        <Link to="/all-vehicles" className="btn-primary mt-6 mb-14">
          Browse Vehicles
        </Link>
      </div>
    );
    ...
    <div className="px-6 md:px-10">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 pb-16">
        {bookings.map((vehicle) => (
          ...
          >
            {/* Image */}
            <div className="h-[15.2rem] md:h-[13.2rem] overflow-hidden">
              <img
            ...
            <div className="card-body p-6 flex flex-col justify-between">
              <div className="space-y-4">
                <div className="flex justify-between items-start">
                  <h2 className="card-title font-bold leading-snug text-gray-800 dark:text-gray-100">
                    {vehicle.vehicleName}
                  </h2>
                ...
                <div className="flex items-center justify-between text-xs text-gray-600 dark:text-gray-400 my-2">
                  <p className="flex items-center gap-1 font-bold text-xl text-primary">
                    <FaDollarSign /> {vehicle.pricePerDay} <span>/ Day</span>
                  </p>
