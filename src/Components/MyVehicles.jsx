...
const MyVehicles = () => {
  ...
  const {
    ...
    enabled: !!providerEmail, // only run when email is ready
  });
  ...
  return (
    <div className="px-6 md:px-10 ">
      <h2 className="text-[2rem] md:text-[2.8rem] font-bold text-center py-12">
        My Listed <span className="text-gradient">Vehicles</span>
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-16">
        {vehicles.map((vehicle) => (
          <div
            key={vehicle._id}
            className="card rounded-xl overflow-hidden shadow hover:shadow-lg dark:hover:shadow-[0_0_10px_rgba(255,255,255,0.05)] transition duration-300 transform hover:scale-[1.02] group bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700"
          >
            {/* Image */}
            <div className="relative h-56 w-full overflow-hidden">
              <img
            ...
            <div className="card-body p-6 flex flex-col justify-between">
              <div className="space-y-4">
                <div className="flex justify-between items-start">
                  <h2 className="card-title text-xl font-bold leading-snug text-gray-800 dark:text-gray-100">
                    {vehicle.vehicleName}
                  </h2>
                ...
                <div className="flex gap-4 text-sm text-gray-600 dark:text-gray-400">
                  <div className="flex items-center gap-1">
                    <FaTags className="text-primary text-sm" /> {vehicle.category}
                  </div>
                  <div className="flex items-center gap-1">
